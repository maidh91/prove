// $ANTLR 3.1.3 Mar 18, 2009 10:09:25 CPP.g 2009-11-13 16:48:10
...
public class CPPLexer extends Lexer {
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CPP.g:829:3: ( LETTER ( LETTER | '0' .. '9' )* )
            // CPP.g:829:5: LETTER ( LETTER | '0' .. '9' )*
            {
            mLETTER(); 
            // CPP.g:829:12: ( LETTER | '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mCHARACTER_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CPP.g:840:3: ( '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\'' )
            // CPP.g:840:7: '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\''
            {
            match('\''); 
            // CPP.g:840:12: ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )
            int alt2=2;
    ...
    public final void mSTRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CPP.g:844:3: ( '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"' )
            // CPP.g:844:6: '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 
            // CPP.g:844:10: ( EscapeSequence | ~ ( '\\\\' | '\"' ) )*
            loop3:
            do {
                int alt3=3;
    ...
    public final void mHEX_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CPP.g:848:3: ( '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )? )
            // CPP.g:848:5: '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
            ...
            // CPP.g:848:29: ( IntegerTypeSuffix )?
            int alt5=2;
    ...
    public final void mDECIMAL_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CPP.g:852:3: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )? )
            // CPP.g:852:5: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )?
            {
            // CPP.g:852:5: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt7=2;
            ...
            // CPP.g:852:32: ( IntegerTypeSuffix )?
            int alt8=2;
    ...
    public final void mOCTAL_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CPP.g:856:3: ( '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )? )
            // CPP.g:856:5: '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
            // CPP.g:856:9: ( '0' .. '7' )+
            int cnt9=0;
            ...
            // CPP.g:856:21: ( IntegerTypeSuffix )?
            int alt10=2;
    ...
    public final void mHexDigit() throws RecognitionException {
        try {
            // CPP.g:860:10: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // CPP.g:860:12: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public final void mFLOATING_POINT_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CPP.g:869:3: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent | ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix )
            int alt23=4;
            alt23 = dfa23.predict(input);
            switch (alt23) {
                case 1 :
                    // CPP.g:869:7: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )?
                    {
                    // CPP.g:869:7: ( '0' .. '9' )+
                    int cnt13=0;
                    loop13:
                    ...
                    break;
                case 2 :
                    // CPP.g:870:7: '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )?
                    {
                    match('.'); 
                    // CPP.g:870:11: ( '0' .. '9' )+
                    int cnt17=0;
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // CPP.g:872:7: ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix
                    {
                    // CPP.g:872:7: ( '0' .. '9' )+
                    int cnt21=0;
                    loop21:
    ...
    public final void mExponent() throws RecognitionException {
        try {
            // CPP.g:876:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // CPP.g:876:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
    ...
    public final void mFloatTypeSuffix() throws RecognitionException {
        try {
            // CPP.g:879:17: ( ( 'f' | 'F' | 'd' | 'D' ) )
            // CPP.g:879:19: ( 'f' | 'F' | 'd' | 'D' )
            {
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            // CPP.g:883:3: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | OctalEscape )
            int alt26=2;
    ...
    public final void mOctalEscape() throws RecognitionException {
        try {
            // CPP.g:889:3: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt27=3;
    ...
    public final void mUnicodeEscape() throws RecognitionException {
        try {
            // CPP.g:896:3: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
            // CPP.g:896:7: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
            {
            match('\\'); 
            match('u'); 
            mHexDigit(); 
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CPP.g:903:3: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // CPP.g:903:7: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // CPP.g:903:12: ( options {greedy=false; } : . )*
            loop28:
            do {
                int alt28=2;
    ...
    class DFA23 extends DFA {
        ...
        public String getDescription() {
            return "868:1: FLOATING_POINT_LITERAL : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent | ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix );";
        }
    }
