...
public class PrettyOutputVisitor extends DoNothingVisitor {
	...
	public Object visitProgramAST(ProgramAST ast, Object o)
		...
		em.printout("#include \"verify.h\"" + newline() + newline());
		ast.dl.visit(this, o);
		em.printToC();
		return null;
	}
	...
	public Object visitIntLiteralAST(IntLiteralAST ast, Object o)
		...
		if(check != null && check.equals("prepost"))
	...
	public Object visitEleExprAST(EleExprAST ast, Object o)
			throws CompilationException {
		String check = (String) o;
		if(check != null && check.equals("getname"))
			return ast.name.getText();
		else if(check != null && check.equals("index")) {
			String e = (String) ast.e.visit(this, "prepost");
			return e;
		}
		else if(check != null && check.equals("prepost")) { 
			String e = (String) ast.e.visit(this, o);
			return ast.name.getText() + "[" + e + "]";
			//ast.e.visit(this, "arraytype1");
		}	
		else {
			em.printout(ast.name.getText());
	...
	public Object visitUnaryExprAST(UnaryExprAST ast, Object o)
		...
		String check = (String) o;
		if(check != null && check.equals("prepost")) {
			if(ast.opType == 2 || ast.opType == 3) {
				em.printout(ast.op.getText());
				String e = (String) ast.e.visit(this, null);
				em.printout(";" + newline());
				indentString();
				return e;
			} else {
				String e = (String) ast.e.visit(this, o);
				return e + ast.op.getText();
			}
		} else {
	...
	public Object visitBinExprAST(BinExprAST ast, Object o)
		...
		if (checkAssign != null && checkAssign.equals("assign"))
			checkAssgn = true;
		else if (checkAssign != null && checkAssign.equals("prepost")) {
			String e1 = (String) ast.e1.visit(this, o);
			String e2 = (String) ast.e2.visit(this, o);
			return e1 + " " + ast.op.getText() + " " + e2;
		}
		else
			checkAssgn = false;
		if (ast.opType >= 24 && ast.opType <= 28) {
			...
			String name = null;
			if(ast.e1 instanceof EleExprAST)
				name = (String) ast.e1.visit(this, "getname");
			if(name != null && name.equals("a") && ast.opType == 0) {
				String e1 = (String) ast.e1.visit(this, "index");
				String e2 = (String) ast.e2.visit(this, "prepost");
				String code1 = e1.replaceAll("\\+\\+", "");
				code1 = code1.replaceAll("--", "");
				String code2 = e2.replaceAll("\\+\\+", "");
				code2 = code2.replaceAll("--", "");
				String temp1 = "_temp" + line;
				em.printout("int " + temp1 + " = " + code1 + ";" + newline());
				indentString();
				String temp2 = "_temp" + line;
				em.printout("int " + temp2 + " = " + code2 + ";" + newline());
				indentString();
				em.printout("fprintf(output, \"%c%d%c%d%c\", '(', " + temp1 + ", ',' , " + temp2 + ", ')');" + newline());
				indentString();
				em.printout("a[" + temp1 + "] = " + temp2 + ";" + newline());// + ";" + newline());
				indentString();
				em.printout(e1 + "; " + e2);
			}
			else {
	...
	public Object visitExprListAST(ExprListAST ast, Object o)
		...
		if (check != null && check.equals("arraytype1")) {
			ast.e.visit(this, "arraytype");
		}
